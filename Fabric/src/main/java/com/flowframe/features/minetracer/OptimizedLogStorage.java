...
public class OptimizedLogStorage {
                    ...
                    if (allLogs != null) {
                        ...
                        for (Map<String, Object> obj : containerList) {
                            ...
                            try {
                                ...
                                LogEntry entry = new LogEntry((String)obj.get("action"), (String)obj.get("playerName"), pos, stack, java.time.Instant.parse((String)obj.get("timestamp")));
                                logs.add(entry);
                                ...
                                System.err.println("[MineTracer] Failed to parse NBT for container log: " + nbtEx.getMessage());
                            }
                        }
                        ...
                        for (Map<String, Object> obj : blockList) {
                            String[] posParts = ((String)obj.get("pos")).split(",");
                            BlockPos pos = new BlockPos(Integer.parseInt(posParts[0]), Integer.parseInt(posParts[1]), Integer.parseInt(posParts[2]));
                            BlockLogEntry entry = new BlockLogEntry((String)obj.get("action"), (String)obj.get("playerName"), pos, (String)obj.get("blockId"), (String)obj.get("nbt"), java.time.Instant.parse((String)obj.get("timestamp")));
                            blockLogs.add(entry);
                        ...
                        for (Map<String, Object> obj : signList) {
                            String[] posParts = ((String)obj.get("pos")).split(",");
                            BlockPos pos = new BlockPos(Integer.parseInt(posParts[0]), Integer.parseInt(posParts[1]), Integer.parseInt(posParts[2]));
                            SignLogEntry entry = new SignLogEntry((String)obj.get("action"), (String)obj.get("playerName"), pos, (String)obj.get("text"), (String)obj.get("nbt"), java.time.Instant.parse((String)obj.get("timestamp")));
                            signLogs.add(entry);
                        ...
                        for (Map<String, Object> obj : killList) {
                            String[] posParts = ((String)obj.get("pos")).split(",");
                            BlockPos pos = new BlockPos(Integer.parseInt(posParts[0]), Integer.parseInt(posParts[1]), Integer.parseInt(posParts[2]));
                            KillLogEntry entry = new KillLogEntry((String)obj.get("killerName"), (String)obj.get("victimName"), pos, (String)obj.get("world"), java.time.Instant.parse((String)obj.get("timestamp")));
                            killLogs.add(entry);
    ...
    public static CompletableFuture<List<BlockLogEntry>> getBlockLogsInRangeAsync(BlockPos center, int range, String userFilter) {
    ...
    public static CompletableFuture<List<SignLogEntry>> getSignLogsInRangeAsync(BlockPos center, int range, String userFilter) {
    ...
    public static CompletableFuture<List<KillLogEntry>> getKillLogsInRangeAsync(BlockPos center, int range, String userFilter, boolean filterByKiller) {
    ...
    public static void registerServerLifecycle() {
        net.fabricmc.fabric.api.event.lifecycle.v1.ServerLifecycleEvents.SERVER_STARTING.register(server -> {
            try {
                ...
                startPeriodicSaving();
                com.flowframe.features.minetracer.KillLogger.register();
            } catch (Exception e) {
